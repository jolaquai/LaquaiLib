...
public static class DbContextExtensions
{
    ...
    public static IEnumerable<object> EnumeratePendingObjects(this DbContext context) => EnumeratePendingEntries(context).Select(e => e.Entity);
    /// <summary>
    ...
    public static IEnumerable<TUnderlying> EnumeratePendingObjects<TUnderlying>(this DbContext context) where TUnderlying : class => EnumeratePendingEntries<TUnderlying>(context).Select(e => e.Entity);
    /// <summary>
    ...
    public static IEnumerable<EntityEntry> EnumeratePendingEntries(this DbContext context) => context.ChangeTracker.Entries().Where(e => e.State is EntityState.Added or EntityState.Modified or EntityState.Deleted);
    /// <summary>
    ...
    public static IEnumerable<EntityEntry<TUnderlying>> EnumeratePendingEntries<TUnderlying>(this DbContext context)
        where TUnderlying : class => context.ChangeTracker.Entries<TUnderlying>().Where(e => e.State is EntityState.Added or EntityState.Modified or EntityState.Deleted);
}
