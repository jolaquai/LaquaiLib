...
public static class PropertyInfoExtensions
{
    ...
    /// <param name="obj">The <see cref="object"/> instance to retrieve the value from. May be <c>null</c> if <paramref name="propertyInfo"/> represents a property that is static.</param>
