...
public static class StackTraceExtensions
{
    ...
    private static extern ref StackFrame[] _stackFrames(StackTrace stackTrace);
    ...
    /// </remarks>
    public static ReadOnlyMemory<StackFrame> GetFrames(this StackTrace stackTrace, int start = 0, int? length = null)
    {
        ...
        if (System.Runtime.CompilerServices.Unsafe.IsNullRef(ref frames))
        {
            return default;
        }
    ...
    public static StackFrame GetLastFrame(this StackTrace stackTrace) => stackTrace.GetFrame(stackTrace.FrameCount - 1);
}
