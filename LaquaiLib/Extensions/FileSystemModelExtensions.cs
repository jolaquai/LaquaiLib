...
public static partial class FileSystemModelExtensions
{
    ...
    /// <summary>
    /// Creates a <see cref="FileInfo"/> instance for a file identified by <paramref name="name"/>. If <paramref name="di"/> does not exist, <see langword="null"/> is returned.
    /// </summary>
    /// <param name="di">The <see cref="DirectoryInfo"/> instance to use as the current directory.</param>
    ...
    /// <summary>
    /// Creates a <see cref="FileInfo"/> instance for a file identified by <paramref name="names"/>. If <paramref name="di"/> does not exist, <see langword="null"/> is returned.
    /// </summary>
    /// <param name="di">The <see cref="DirectoryInfo"/> instance to use as the current directory.</param>
    /// <param name="names">Any number of directory names to join and search for under the directory represented by <paramref name="di"/>.</param>
    ...
    public static FileInfo File(this DirectoryInfo di, params ReadOnlySpan<string> names) => di.GetFile(Path.Combine(names));
