...
public static class DispatcherObjectExtensions
{
    ...
    public static void Dispatch(this DispatcherObject dispatcherObject, Action action)
    {
    ...
    public static void Dispatch(this DispatcherObject dispatcherObject, Delegate method, params object?[]? arguments)
    {
        dispatcherObject.Dispatcher.Invoke(method, arguments);
    }
    /// <summary>
    ...
    public static T Dispatch<T>(this DispatcherObject dispatcherObject, Func<T> func)
    {
    ...
    public static async Task DispatchAsync(this DispatcherObject dispatcherObject, Action action)
    {
    ...
    public static async Task DispatchAsync(this DispatcherObject dispatcherObject, Func<Task> asyncDelegate)
    {
        await dispatcherObject.Dispatcher.InvokeAsync(asyncDelegate);
    }
    /// <summary>
    /// Asynchronously invokes the specified <paramref name="asyncDelegate"/> on the thread the <paramref name="dispatcherObject"/> was created on.
    /// </summary>
    ...
    /// <param name="asyncDelegate">The <see cref="Func{TResult}"/> to invoke.</param>
    /// <returns>The <see cref="Task{TResult}"/> returned by the <paramref name="asyncDelegate"/>.</returns>
    public static async Task<T> DispatchAsync<T>(this DispatcherObject dispatcherObject, Func<Task<T>> asyncDelegate)
    {
        return await await dispatcherObject.Dispatcher.InvokeAsync(asyncDelegate);
    }
}
