...
public static class ConstructorInfoExtensions
{
    ...
    public static object? New(this ConstructorInfo constructorInfo, params ReadOnlySpan<object> parameters)
    {
        try
        {
    ...
    public static T? New<T>(this ConstructorInfo constructorInfo, params ReadOnlySpan<object?> parameters)
    {
        try
        {
            return (T?)constructorInfo.Invoke(parameters.ToArray());
        }
        catch
        {
            return default;
