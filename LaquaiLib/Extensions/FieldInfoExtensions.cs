...
public static class FieldInfoExtensions
{
    ...
    /// <param name="obj">The <see cref="object"/> instance to retrieve the value from. May be <c>null</c> if <paramref name="fieldInfo"/> represents a field that is static.</param>
