...
public readonly struct AsyncEnumeratorWrapper<T> : IAsyncEnumerator<T>
{
    /// <summary>
    ...
    private readonly IEnumerator<T> _from;
    ...
    public AsyncEnumeratorWrapper(IEnumerator<T> from) => _from = from;
    /// <summary>
