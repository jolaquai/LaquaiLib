...
public static class Assert
{
    ...
    public static bool That(Func<bool> condition)
    {
        return condition() ? true : throw new AssertionFailureException<bool>(false);
    }
    /// <summary>
    ...
    /// <returns>The result of the invocation of <paramref name="condition"/> if it is <see langword="true"/>, otherwise an <see cref="AssertionFailureException{T}"/> is thrown.</returns>
    public static bool That(Func<bool> condition, string message)
    {
        return condition() ? true : throw new AssertionFailureException<bool>(false, message);
    }
    ...
    {
        return value is null ? value : throw new AssertionFailureException<T>(value, message);
    }
    /// <summary>
    ...
    {
        return value ?? throw new AssertionFailureException<T>(value, message);
    }
    /// <summary>
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsGreaterThanOrEqualTo<T>(T value, T other, string message = "") where T : IComparable<T>
    {
        return value.CompareTo(other) >= 0 ? value : throw new AssertionFailureException<T>(value, message);
    }
    /// <summary>
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsLessThan<T>(T value, T other, string message = "") where T : IComparable<T>
    {
        return value.CompareTo(other) < 0 ? value : throw new AssertionFailureException<T>(value, message);
    }
    /// <summary>
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsLessThanOrEqualTo<T>(T value, T other, string message = "") where T : IComparable<T>
    {
        return value.CompareTo(other) <= 0 ? value : throw new AssertionFailureException<T>(value, message);
    }
    /// <summary>
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsEqualTo<T>(T value, T other, string message = "") where T : IComparable<T>
    {
        return value.CompareTo(other) == 0 ? value : throw new AssertionFailureException<T>(value, message);
    }
    /// <summary>
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsNotEqualTo<T>(T value, T other, string message = "") where T : IComparable<T>
    {
        return value.CompareTo(other) != 0 ? value : throw new AssertionFailureException<T>(value, message);
    }
    /// <summary>
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsInRange<T>(T value, T min, T max, string message = "") where T : IComparable<T>
    {
        return value.CompareTo(min) >= 0 && value.CompareTo(max) <= 0 ? value : throw new AssertionFailureException<T>(value, message);
    }
    /// <summary>
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsNotInRange<T>(T value, T min, T max, string message = "") where T : IComparable<T>
    {
        return value.CompareTo(min) < 0 || value.CompareTo(max) > 0 ? value : throw new AssertionFailureException<T>(value, message);
    }
    /// <summary>
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsPositive<T>(T value, string message = "") where T : IComparable<T>
    {
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsNegative<T>(T value, string message = "") where T : IComparable<T>
    {
        return value.CompareTo(default) < 0 ? value : throw new AssertionFailureException<T>(value, message);
    }
    /// <summary>
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsZero<T>(T value, string message = "") where T : IComparable<T>
    {
        return value.CompareTo(default) == 0 ? value : throw new AssertionFailureException<T>(value, message);
    }
    /// <summary>
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsNonZero<T>(T value, string message = "") where T : IComparable<T>
    {
        return value.CompareTo(default) != 0 ? value : throw new AssertionFailureException<T>(value, message);
    }
    /// <summary>
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsDefault<T>(T value, string message = "")
    {
    ...
    /// <param name="message">The message to include in the <see cref="AssertionFailureException{T}"/> if the assertion fails. May be <see langword="null"/> or empty to use the default message.</param>
    /// <returns><paramref name="value"/> if the assertion succeeds, otherwise the method will not return.</returns>
    public static T IsNotDefault<T>(T value, string message = "")
    {
        return !value.Equals(default) ? value : throw new AssertionFailureException<T>(value, message);
    }
}
