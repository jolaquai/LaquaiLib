...
public static class SilentFullAccessDynamicFactory
{
    ...
    public static dynamic Create(Type type)
    {
        ...
        return Activator.CreateInstance(typeof(SilentFullAccessDynamic<>).MakeGenericType(type), bindingAttr: BindingFlags.Instance | BindingFlags.NonPublic, null, [Activator.CreateInstance(type)], null);
    }
    /// <summary>
