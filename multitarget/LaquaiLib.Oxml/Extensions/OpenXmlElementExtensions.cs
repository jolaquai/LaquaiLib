...
public static class OpenXmlElementExtensions
{
    ...
    extension(OpenXmlElement element)
    {
        ...
        public bool DeepEquals(OpenXmlElement other) => OpenXmlElementComparers.Default.Equals(element, other);
        ...
        /// </remarks>
        public OpenXmlElement[] ElementsBetween(OpenXmlElement child1, OpenXmlElement child2)
        {
    ...
    extension(IEnumerable<OpenXmlElement> elements)
    {
        /// <summary>
    ...
    extension<T>(T element) where T : OpenXmlCompositeElement
    {
        /// <summary>
