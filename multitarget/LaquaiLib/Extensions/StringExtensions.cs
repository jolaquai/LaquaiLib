...
public static partial class StringExtensions
{
    extension(string source)
    {
        ...
        public (string Value, string Separator)[] TransparentSplit(StringSplitOptions options = StringSplitOptions.None, params string[] splitStrings)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IEnumerable<int> IndicesOf(ReadOnlySpan<char> search) => source.IndicesOf(search, 0);
        /// <summary>
        ...
        /// <returns>All zero-based index positions of <paramref name="search"/> if that <see langword="char"/> span is found, or an empty collection otherwise.</returns>
        public IEnumerable<int> IndicesOf(ReadOnlySpan<char> search, int startIndex)
        {
            List<int> ret = [];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IEnumerable<int> IndicesOf(char search) => source.IndicesOf(search, 0);
        /// <summary>
        ...
        /// <param name="startIndex">The search starting position.</param>
        /// <returns>All zero-based index positions of <paramref name="search"/> if that character is found, or an empty collection otherwise.</returns>
        public IEnumerable<int> IndicesOf(char search, int startIndex)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IEnumerable<int> IndicesOf(string search) => source.IndicesOf(search, 0);
        /// <summary>
        ...
        /// <returns>All zero-based index positions of <paramref name="search"/> if that string is found, or an empty collection otherwise.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IEnumerable<int> IndicesOf(string search, int startIndex) => source.IndicesOf(search.AsSpan(), startIndex);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int IndexOfAny(ReadOnlySpan<char> searches) => source.AsSpan().IndexOfAny(searches);
        /// <summary>
        ...
        /// <returns>The zero-based index position of the first occurrence in this instance where any <see langword="char"/> in <paramref name="searches"/> was found; -1 if no <see langword="char"/> in <paramref name="searches"/> was found.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int IndexOfAny(ReadOnlySpan<char> searches, int startIndex) => source.AsSpan(startIndex).IndexOfAny(searches);
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int IndexOfAny(ReadOnlySpan<string> searches, StringComparison stringComparison = StringComparison.CurrentCulture) => source.AsSpan().IndexOfAny(SearchValues.Create(searches, stringComparison));
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int IndexOfAny(ReadOnlySpan<string> searches, int startIndex, StringComparison stringComparison = StringComparison.CurrentCulture) => source.AsSpan(startIndex).IndexOfAny(SearchValues.Create(searches, stringComparison));
        ...
        /// <param name="startIndex">The search starting position.</param>
        /// <returns>The zero-based index positions of all occurrences in this instance where any character in <paramref name="searches"/> was found; an empty collection if no character in <paramref name="searches"/> was found.</returns>
        public IEnumerable<int> IndicesOfAny(ReadOnlySpan<char> searches, int startIndex)
        {
            List<IEnumerable<int>> indexLists = [];
            foreach (var search in searches)
            {
        ...
        /// <param name="startIndex">The search starting position.</param>
        /// <returns>The zero-based index positions of all occurrences in this instance where any string in <paramref name="searches"/> was found; an empty collection if no string in <paramref name="searches"/> was found.</returns>
        public IEnumerable<int> IndicesOfAny(ReadOnlySpan<string> searches, int startIndex)
        {
            List<IEnumerable<int>> indexLists = [];
            foreach (var search in searches)
            {
        ...
        /// <param name="startIndex">The search starting position.</param>
        /// <returns>All zero-based index positions of any characters that are left, or an empty collection otherwise.</returns>
        public IEnumerable<int> IndicesOfExcept(string except, int startIndex)
        {
            var exceptSet = new HashSet<char>(except);
        ...
        public int IndexOfAnyExcept(ReadOnlySpan<char> excepts, int startIndex) => source.AsSpan(startIndex).IndexOfAnyExcept(excepts);
        /// <summary>
        ...
        /// <param name="startIndex">The search starting position.</param>
        /// <returns>The zero-based index positions of all occurrences in this instance where any character not contained in <paramref name="excepts"/> was found, or an empty collection otherwise.</returns>
        public IEnumerable<int> IndicesOfAnyExcept(ReadOnlySpan<char> excepts, int startIndex)
        {
            var indexes = new List<int>();
        ...
        public IEnumerable<int> IndicesOfAnyExcept(ReadOnlySpan<string> excepts, StringComparison stringComparison = StringComparison.CurrentCulture)
        {
            var indexes = new List<int>();
            var index = -1;
        ...
        /// <param name="stringComparison">A <see cref="StringComparison"/> value specifying the comparison behavior.</param>
        /// <returns>The zero-based index positions of all occurrences in this instance where any string not contained in <paramref name="excepts"/> was found, or an empty collection otherwise.</returns>
        public IEnumerable<int> IndicesOfAnyExcept(ReadOnlySpan<string> excepts, int startIndex, StringComparison stringComparison = StringComparison.CurrentCulture)
        {
            var indexes = new List<int>();
            var index = startIndex - 1;
        ...
        /// <returns></returns>
        public string SelectLines(Func<string, string> transform, Func<string, bool> predicate) => string.Join(Environment.NewLine, source.Split(Environment.NewLine).Select(line => predicate(line) ? transform(line) : line));
        /// <summary>
        ...
        /// <param name="predicate">The function used to determine which lines are transformed using <paramref name="transform"/>.</param>
        /// <returns></returns>
        public string SelectLines(Func<string, int, string> transform, Func<string, int, bool> predicate) => string.Join(Environment.NewLine, source.Split(Environment.NewLine).Select((line, index) => predicate(line, index) ? transform(line, index) : line));
        ...
        public double GetSimilarity(string second, StringComparer stringComparer = null)
        {
