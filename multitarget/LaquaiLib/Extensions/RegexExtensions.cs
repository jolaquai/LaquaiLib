...
{
    [UnsafeAccessor(UnsafeAccessorKind.Field)] private static extern ref Regex _regex(this Match match);
    [UnsafeAccessor(UnsafeAccessorKind.Field, Name = "<Text>k__BackingField")] private static extern ref string get_Text(this Capture capture);
    ...
    public static string GetOriginalText(this Capture capture)
    {
