...
/// <summary>
/// Provides extensions for the <see cref="IDictionary{TKey, TValue}"/> type.
/// </summary>
public static class IDictionaryExtensions
{
    extension<TKey, TValue>(IDictionary<TKey, TValue> source)
    {
        ...
        public void AddOrUpdate(TKey key, TValue addValue, Func<TValue, TValue, TValue> updateValueFactory)
        {
            ArgumentNullException.ThrowIfNull(source);
            ArgumentNullException.ThrowIfNull(key);
            if (source.IsReadOnly)
        ...
        public void AddOrUpdate(TKey key, Func<TValue> addValueFactory, Func<TValue, TValue> updateValueFactory)
        {
            ArgumentNullException.ThrowIfNull(source);
            ArgumentNullException.ThrowIfNull(key);
            if (source.IsReadOnly)
    ...
    extension<TKey, TValue>(Dictionary<TKey, TValue> dictionary) where TKey : notnull
    {
        ...
        public ref TValue GetValueRefOrNullRef(TKey key, out bool existed)
        {
        ...
        public ref TValue GetValueRefOrAdd(TKey key, TValue value, out bool existed)
        {
            ArgumentNullException.ThrowIfNull(dictionary);
            ArgumentNullException.ThrowIfNull(key);
        ...
        /// <param name="existed">An <see langword="out"/> variable that indicates whether the key-value pair was present in the <paramref name="dictionary"/>.</param>
        /// <returns>A <see langword="ref"/> into the storage of the <paramref name="dictionary"/>.</returns>
        public ref TValue GetValueRefOrAdd(TKey key, Func<TValue> valueFactory, out bool existed)
        {
            ArgumentNullException.ThrowIfNull(dictionary);
            ArgumentNullException.ThrowIfNull(key);
        ...
        public ref TValue GetValueRefOrNullRef(TKey key) => ref CollectionsMarshal.GetValueRefOrNullRef(dictionary, key);
    ...
    extension<TKey, TValue, TAlternateKey>(in Dictionary<TKey, TValue>.AlternateLookup<TAlternateKey> dictionary)
    {
        ...
        /// <inheritdoc cref="CollectionsMarshal.GetValueRefOrAddDefault{TKey, TValue}(Dictionary{TKey, TValue}, TKey, out bool)"/>
        public ref TValue GetValueRefOrAddDefault(TAlternateKey key, out bool existed) => ref CollectionsMarshal.GetValueRefOrAddDefault(dictionary, key, out existed);
    }
}
