...
public static class IGroupingExtensions
{
    ...
    extension<TKey, TElement>(IEnumerable<IGrouping<TKey, TElement>> source) where TKey : notnull
    {
        /// <summary>
    ...
    // Warning: don't refactor these into extension() blocks since that'd cause ambiguities
