...
/// <summary>
/// Wraps an <see cref="IEnumerable{T}"/> as an <see cref="IAsyncEnumerable{T}"/> to allow asynchronous consumption by delegating to <see cref="AsyncEnumeratorWrapper{T}"/>.
/// </summary>
