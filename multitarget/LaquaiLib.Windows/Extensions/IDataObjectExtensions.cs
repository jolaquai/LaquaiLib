...
{
    extension(IDataObject dataObject)
    {
        /// <summary>
        ...
        public bool TryGetData(string format, [NotNullWhen(true)] out object data)
        {
        ...
        /// <returns><see langword="true"/> if the retrieval was successful, otherwise <see langword="false"/>.</returns>
        public bool TryGetData<T>(string format, [NotNullWhen(true)] out T data)
        {
