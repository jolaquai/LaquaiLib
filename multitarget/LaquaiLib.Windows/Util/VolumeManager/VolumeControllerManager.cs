...
public class VolumeControllerManager(Action<AudioSessionControl2> defaultOnFocusReceived, Action<AudioSessionControl2> defaultOnFocusLost)
{
    private readonly Action<AudioSessionControl2> _defaultOnFocusReceived = defaultOnFocusReceived;
    private readonly Action<AudioSessionControl2> _defaultOnFocusLost = defaultOnFocusLost;
